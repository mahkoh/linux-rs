...
pub type AtomicChar = atomic::AtomicI8;
pub type AtomicSChar = atomic::AtomicI8;
pub type AtomicUChar = atomic::AtomicU8;
pub type AtomicShort = atomic::AtomicI16;
pub type AtomicUShort = atomic::AtomicU16;
pub type AtomicInt = atomic::AtomicI32;
pub type AtomicUInt = atomic::AtomicU32;
pub type AtomicLongLong = atomic::AtomicI64;
pub type AtomicULongLong = atomic::AtomicU64;

pub use self::abi::{
    c_long, c_ulong, AtomicLong, AtomicULong,
};
...
pub const INT_MAX: c_int = i32::max_value();
...
pub const MAP_32BIT    : kty::c_int = 0x40;
pub const MAP_HUGE_2MB : kty::c_int = 21 << MAP_HUGE_SHIFT;
pub const MAP_HUGE_1GB : kty::c_int = 30 << MAP_HUGE_SHIFT;
...
pub use kty::gen::{
    siginfo_t, _siginfo_fields, _siginfo_variant, siginfo_sigfault,
};
